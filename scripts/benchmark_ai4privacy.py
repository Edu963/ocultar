...
CATEGORY_MAP = {
    "EMAIL": "EMAIL",
    "SOCIALNUMBER": "SSN",
    "IDCARD": "SSN", # Approximation
    "PASS": "SSN", # Approximation
    "FIRSTNAME": "PERSON",
    "LASTNAME1": "PERSON",
    "LASTNAME2": "PERSON",
    "USERNAME": "PERSON",
...
def evaluate():
    ...
    for i, sample in enumerate(tqdm(samples)):
        ...
        ground_truth = sample["span_labels"] # [start, end, label]
        ...
        try:
            ...
            print(f"Error parsing span_labels: {e}")
            continue
    ...
    print("\n--- ai4privacy PII Benchmark Results ---")
