...
echo "================================================="
echo " OCULTAR ENTERPRISE (Dual-Tier) - Setup"
echo "================================================="
...
echo "[i] Building Enterprise environment & starting the OCULTAR vault..."
echo "[i] The first run will download the local AI model (~1.2GB). Please wait..."
docker compose pull
docker compose build
docker compose up -d

# 4. Open dashboard
echo "[✓] OCULTAR Enterprise Engine is running!"
