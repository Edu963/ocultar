# Sombra | Ocultar Enterprise Gateway

Sombra is the enterprise-grade API gateway for the Ocultar ecosystem. It is a drop-in
...
- **Tier 2 AI NER** — optional SLM sidecar activated by `OCU_FORCE_ENTERPRISE=true` or a valid enterprise licence
...
| `GET`  | `/healthz` | Health check — returns vault count and licence tier |
...
| `OCU_FORCE_ENTERPRISE` | No | `true` to activate enterprise mode without a licence file |
