        ...
        <div className="min-h-screen font-sans antialiased bg-white text-gray-900 selection:bg-cyan-500 selection:text-black pb-32">
            ...
            <div className="max-container pt-32 relative z-10">
                ...
                <header className="max-w-4xl mx-auto text-center space-y-8 mb-20">
                    ...
                    <h1 className="tracking-tighter text-gray-900">
                ...
                <div className="max-w-5xl mx-auto">
                        ...
                        <div className="space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {[
                                    ...
                                    <div key={item.id} className="card bg-white hover:border-cyan-500/30 transition-colors border-gray-200 shadow-sm">
                                        <div className="w-12 h-12 bg-gray-50 border border-gray-100 rounded-xl flex items-center justify-center mb-6 text-cyan-600">
                                            {item.icon}
                                        </div>
                    ...
                    {/* STEP 2: INPUT */}
                    {step === 2 && (
                        <div className="card max-w-3xl mx-auto bg-white space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 shadow-xl border-gray-200">
                            <div className="flex gap-2 p-1 bg-gray-50 rounded-xl border border-gray-100">
                                <button 
                                    onClick={() => setInputType('paste')}
                                    className={`flex-1 py-4 text-[10px] font-bold uppercase tracking-widest rounded-lg transition-all ${inputType === 'paste' ? 'bg-white text-cyan-600 shadow-sm border border-gray-100' : 'text-gray-400 hover:text-gray-600'}`}
                                >
                                    Paste Dataset
                                </button>
                                <button 
                                    onClick={() => setInputType('upload')}
                                    className={`flex-1 py-4 text-[10px] font-bold uppercase tracking-widest rounded-lg transition-all ${inputType === 'upload' ? 'bg-white text-cyan-600 shadow-sm border border-gray-100' : 'text-gray-400 hover:text-gray-600'}`}
                                >
                                    Upload File
                                </button>
                            </div>
                                ...
                                {inputType === 'paste' ? (
                                    ...
                                    <div className="relative border-2 border-dashed border-gray-200 rounded-2xl h-80 flex flex-col items-center justify-center p-8 text-center gap-6 bg-gray-50/50 hover:bg-gray-50 transition-colors cursor-pointer group hover:border-cyan-500/30">
                                        ...
                                        <input 
                                            ...
                                            accept=".csv,.json,.txt"
                                        />
                                        {file && <div className="absolute inset-0 bg-white rounded-2xl flex items-center justify-center gap-3 z-20 border border-cyan-500/50 shadow-lg">
                    ...
                    {/* STEP 3: LEAD GATE */}
                    {step === 3 && (
                        <div className="card max-w-lg mx-auto bg-white space-y-10 py-12 animate-in fade-in slide-in-from-bottom-4 duration-700 shadow-xl border-gray-200">
                            ...
                            <form onSubmit={handleUnlock} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-cyan-500/50 transition-colors text-gray-900"
                                ...
                                <button 
                                    className="w-full bg-cyan-600 text-white py-5 rounded-lg text-lg font-bold hover:bg-cyan-700 transition-colors"
                                    disabled={loading}
                                >
                        ...
                        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-20">
                            ...
                            {report.full && (
                                <div className="space-y-24 py-16 border-t border-gray-100 mt-20">
                                    ...
                                    <div className="space-y-12">
                                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                                            <div className="space-y-4">
                                                ...
                                                <h2 className="text-4xl font-bold tracking-tight text-gray-900 flex items-center gap-4">
                                                    Technical Risk Scorecard <BarChart3 className="w-8 h-8 text-cyan-600" />
                                                </h2>
                                            </div>
                                    ...
                                    <div className="space-y-12">
                                        <h2 className="text-4xl font-bold tracking-tight text-gray-900 flex items-center gap-4">
                                            Regulatory Alignment Matrix <Shield className="w-8 h-8 text-cyan-600" />
                                        </h2>
                                                ...
                                                <table className="w-full text-left border-collapse">
                                                    <thead>
                                                        <tr className="bg-gray-50 border-b border-gray-100">
                                                            <th className="p-6 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Sensitive Attribute</th>
                                                            <th className="p-6 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Governing Regulation</th>
                                                            <th className="p-6 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Primary Article</th>
                                                            <th className="p-6 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Security Threat</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {report.full.Risk.regulatory_findings?.map((finding, idx) => (
                                                            <tr key={idx} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                                                <td className="p-6 font-mono text-sm font-bold text-gray-900 flex items-center gap-3">
                                                                    <div className="w-1.5 h-1.5 bg-cyan-600/50 rounded-full"></div>
                                                                    {finding.attribute}
                                                                </td>
                                                                <td className="p-6 text-sm font-medium text-gray-500">{finding.regulation}</td>
                                                                <td className="p-6">
                                                                    <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded font-mono text-[10px] text-cyan-600 font-bold tracking-widest">{finding.article}</span>
                                                                </td>
                                                                <td className="p-6">
                                    ...
                                    <div className="space-y-12">
                                        <h2 className="text-4xl font-bold tracking-tight text-gray-900 flex items-center gap-4">
                                            Ocultar Mitigation Simulation <CheckCircle2 className="w-8 h-8 text-cyan-600" />
                                        </h2>
                                            ...
                                            {[report.full.Before, report.full.After].map((scenario, idx) => (
                                                <div key={scenario.Label} className={`p-12 space-y-10 ${idx === 0 ? 'bg-white border-r border-gray-100' : 'bg-cyan-50/30'}`}>
                                                    <div className="flex justify-between items-center mb-6">
                                                        ...
                                                        <div className={`px-4 py-1.5 border rounded-full text-[10px] font-bold uppercase tracking-widest ${idx === 0 ? 'border-rose-200 text-rose-600' : 'border-cyan-200 text-cyan-600 font-black'}`}>{scenario.RiskLevel}</div>
                                                    </div>
