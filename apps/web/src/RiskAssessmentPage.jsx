...
export default function RiskAssessmentPage() {
  ...
  { "name": "Bob Wilson", "email": "bob@example.com", "region": "East", "dept": "Dev", "salary": 95000 }
    ...
    return (
        <div className="min-h-screen font-sans antialiased bg-[#050505] text-white selection:bg-emerald-500 selection:text-black pb-32">
            ...
            <div className="max-container pt-32 relative z-10">
                ...
                <header className="max-w-4xl mx-auto text-center space-y-8 mb-20">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/5 border border-emerald-500/10 text-[10px] font-bold text-emerald-500 uppercase tracking-widest">
                ...
                <div className="max-w-5xl mx-auto">
                        ...
                        <div className="space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {[
                                    ...
                                    <div key={item.id} className="card bg-zinc-950 hover:border-emerald-500/30 transition-colors">
                            ...
                            <div className="flex justify-center">
                                <button 
                                    onClick={handleStart}
                                    className="bg-emerald-500 text-black px-16 py-6 rounded-lg text-xl font-bold shadow-2xl hover:scale-105 transition-transform flex items-center group"
                                >
                        ...
                        <div className="card max-w-3xl mx-auto bg-zinc-950 space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 shadow-2xl">
                            <div className="flex gap-2 p-1 bg-white/5 rounded-xl border border-white/5">
                                <button 
                                    ...
                                    className={`flex-1 py-4 text-[10px] font-bold uppercase tracking-widest rounded-lg transition-all ${inputType === 'paste' ? 'bg-emerald-500 text-black shadow-lg' : 'text-slate-500 hover:text-white'}`}
                                >
                                    Paste Dataset
                                </button>
                                <button 
                                    onClick={() => setInputType('upload')}
                                    className={`flex-1 py-4 text-[10px] font-bold uppercase tracking-widest rounded-lg transition-all ${inputType === 'upload' ? 'bg-emerald-500 text-black shadow-lg' : 'text-slate-500 hover:text-white'}`}
                                >
                                    Upload File
                                </button>
                            </div>
                                ...
                                {inputType === 'paste' ? (
                                    ...
                                    <div className="relative border-2 border-dashed border-white/10 rounded-2xl h-80 flex flex-col items-center justify-center p-8 text-center gap-6 bg-white/[0.01] hover:bg-white/[0.03] transition-colors cursor-pointer group hover:border-emerald-500/30">
                                        ...
                                        <input 
                                            ...
                                            accept=".csv,.json,.txt"
                                        />
                                        {file && <div className="absolute inset-0 bg-zinc-950 rounded-2xl flex items-center justify-center gap-3 z-20 border border-emerald-500/50 shadow-[0_0_30px_rgba(16,185,129,0.2)]">
                            ...
                            <button 
                                ...
                                className="w-full bg-emerald-500 text-black py-5 rounded-lg text-lg font-bold shadow-xl disabled:opacity-50 hover:bg-emerald-400 transition-colors flex items-center justify-center"
                            >
                    ...
                    {step === 3 && (
                        <div className="card max-w-lg mx-auto bg-zinc-950 space-y-10 py-12 animate-in fade-in slide-in-from-bottom-4 duration-700 shadow-2xl">
                            ...
                            <form onSubmit={handleUnlock} className="space-y-6">
                                ...
                                <button 
                                    className="w-full bg-emerald-500 text-black py-5 rounded-lg text-lg font-bold hover:bg-emerald-400 transition-colors"
                                    disabled={loading}
                                >
                    ...
                    {step === 4 && report && (
                        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-20">
                            {/* Summary Card */}
                            <div className="card bg-emerald-500 text-black p-12 flex flex-col md:flex-row justify-between items-center gap-10 overflow-hidden relative border-none rounded-[2rem]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="card bg-zinc-950 space-y-8">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className={`p-4 rounded-xl ${report.ai_readiness.status === 'ALLOW' ? 'bg-emerald-500/10 text-emerald-500' : 'bg-rose-500/10 text-rose-500'}`}>
                                ...
                                <div className="space-y-24 py-16 border-t border-white/5 mt-20">
                                    ...
                                    <div className="space-y-12">
                                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                                            ...
                                            <p className="text-zinc-500 text-sm max-w-xs font-medium italic underline underline-offset-4 decoration-emerald-500/30">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                            {[
                                                ...
                                                <div key={stat.label} className="card bg-zinc-950 flex flex-col gap-6">
                                                    ...
                                                    <div className={`text-[10px] font-bold uppercase px-4 py-1.5 rounded-full w-fit tracking-widest ${stat.data.score > 7 ? 'bg-rose-500/10 text-rose-400' : stat.data.score > 4 ? 'bg-amber-500/10 text-amber-400' : 'bg-emerald-500/10 text-emerald-400'}`}>
                                                        {stat.data.label}
                                                    </div>
                                                </div>
                                            ))}
                                                    ...
                                                    <tbody>
                                                        {report.full.Risk.regulatory_findings?.map((finding, idx) => (
                                                            <tr key={idx} className="border-b border-white/5 hover:bg-white/[0.03] transition-colors">
                                                                ...
                                                                <td className="p-6">
                                                                    <span className="px-3 py-1 bg-white/5 border border-white/10 rounded font-mono text-[10px] text-emerald-400 font-bold tracking-widest">{finding.article}</span>
                                                                </td>
                                                                <td className="p-6">
                                    ...
                                    <div className="space-y-12">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl">
                                            {[report.full.Before, report.full.After].map((scenario, idx) => (
                                                <div key={scenario.Label} className={`p-12 space-y-10 ${idx === 0 ? 'bg-zinc-950 border-r border-white/10' : 'bg-emerald-500/[0.03]'}`}>
                                                    <div className="flex justify-between items-center mb-6">
                                                        <div className={`text-[10px] font-bold uppercase tracking-[0.4em] ${idx === 0 ? 'text-rose-500' : 'text-emerald-500 font-black'}`}>[ {scenario.Label} ]</div>
                                                        <div className={`px-4 py-1.5 border rounded-full text-[10px] font-bold uppercase tracking-widest ${idx === 0 ? 'border-rose-500/50 text-rose-500' : 'border-emerald-500/50 text-emerald-500 font-black'}`}>{scenario.RiskLevel}</div>
                                                    </div>
                                                    <div className="space-y-6">
                                                        <div className="flex justify-between text-sm py-4 border-b border-white/5">
                                                            ...
                                                            <span className={`font-mono font-bold ${idx === 0 ? 'text-rose-400' : 'text-emerald-400'}`}>{scenario.VaRRange}</span>
                                                        </div>
                                                        <div className="flex justify-between text-sm py-4 border-b border-white/5">
                                    ...
                                    {/* 5. FINAL ACTIONS */}
                                    <div className="bg-emerald-500 text-black p-16 rounded-[3rem] text-center space-y-10 relative overflow-hidden shadow-[0_0_100px_rgba(16,185,129,0.2)]">
