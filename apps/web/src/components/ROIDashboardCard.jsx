    ...
    return (
        <div className="card space-y-6 relative overflow-hidden group border-white/10 bg-black/60 backdrop-blur-3xl shadow-2xl">
            ...
            <div className="absolute top-6 right-6 flex items-center gap-2">
                <div className={`w-2 h-2 rounded-full ${data.status === 'online' ? 'bg-emerald-500 animate-pulse' : 'bg-yellow-500'}`}></div>
            ...
            <div className="space-y-2">
                <h3 className="text-[10px] font-bold uppercase text-emerald-500 tracking-[0.3em] flex items-center gap-2">
                    <Activity className="w-3 h-3" /> {loading ? "Syncing..." : data.name}
                </h3>
                <div className="text-5xl font-bold tracking-tighter tabular-nums text-white group-hover:text-emerald-400 transition-colors">
            ...
            <div className="bg-emerald-500/5 p-4 rounded-xl text-xs font-medium text-slate-400 leading-relaxed border border-emerald-500/10 flex gap-3">
