                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-6">
                        ...
                        <div className="bg-[#0A0A0C] ring-1 ring-white/5 rounded-xl p-6 flex flex-col gap-4 shadow-xl">
                            <p className="text-xs font-mono text-slate-500 uppercase tracking-widest border-b border-white/5 pb-4">
                                Rate Summary
                            </p>
                            ...
                            <div className="bg-[#0A0A0C] ring-1 ring-emerald-500/20 rounded-xl p-6 flex flex-col gap-4 shadow-xl shadow-emerald-500/5">
                                ...
                                <div className="flex flex-col gap-1.5 text-sm text-slate-500 font-mono">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="text-emerald-400">€2,075</span>
                                    </div>
                        ...
                        <div className="bg-[#0A0A0C] ring-1 ring-white/5 rounded-xl p-6 flex flex-col gap-5 shadow-xl">
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="h-3 bg-white/5 rounded-full overflow-hidden">
                                        <div
                                            className="h-full bg-slate-500/70 rounded-full transition-all duration-500 ease-out"
                                            style={{ width: `${cloudBarPct}%` }}
                                        />
                                    </div>
                                </div>
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="h-3 bg-white/5 rounded-full overflow-hidden">
                                        <div
                                            className="h-full bg-emerald-500 rounded-full transition-all duration-500 ease-out shadow-[0_0_8px_rgba(16,185,129,0.5)]"
                                            style={{ width: `${ocultarBarPct}%` }}
                                        />
                                    </div>
                                </div>
                            </div>
                            {savingsPct > 0 && (
                                <p className="text-xs font-mono text-slate-600">
                                    OCULTAR costs{' '}
                                    <span className="text-emerald-400 font-semibold">{savingsPct}% less</span>
