...
3. **SLM Validation**: Verify Tier 2 AI inference is active and performing within 5s.
4. **Migration Test**: Perform a mock DuckDB-to-PostgreSQL transfer.
5. **Web Dashboard**: Verify the Enterprise Dashboard is reachable and serving valid localized assets.
